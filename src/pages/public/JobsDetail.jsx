...
import JobUpdateForm from "../../layouts/company/JobUpdateForm";
...
const JobDetail = () => {
  ...
  return (
    <div className="items-center mx-4 p-4 text-light-text">
      <div className="flex justify-between items-center mb-4">
        <div className="flex items-center">
          <img
            src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/11/FPT_logo_2010.svg/1200px-FPT_logo_2010.svg.png" // Replace with the path to your logo
            alt="Company Logo"
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              ...
              <Tag color="red">Featured</Tag> {/* Added "Featured" tag */}
            </div>
          </div>
        </div>
        <Button
